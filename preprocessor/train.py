...
def train():
    model = preprocessor.PreProcessor(INPUT_CHANNEL, OUTPUT_CHANNEL).to("cuda")
    ...
    for epoch in range(EPOCH):
        ...
        if epoch_loss / batch_count < epoch_min_loss:
            ...
            torch.save(model.state_dict(), f"{PROJECT_NAME}_best.pth")
    ...
    print("Saving model...")
    torch.save(model.state_dict(), f"{PROJECT_NAME}_last.pth")
